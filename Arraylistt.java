...
public class Arraylistt {
    public static void main(String[] args) {
        ...
        dataMahasiswa.add(new Mahasiswa("20200040021", "Dina Cahaya"));
        dataMahasiswa.add(new Mahasiswa("20200040022", "Selvi Amalia"));
        dataMahasiswa.add(new Mahasiswa("20200040023", "Dinda Apriliani"));
        dataMahasiswa.add(new Mahasiswa("20200040024", "Cut Tasya"));

        ArrayList <Buku> dataBuku = new ArrayList<>();

        dataBuku.add(new Buku("01", "Algodata"));
        dataBuku.add(new Buku("02", "Logika"));
        dataBuku.add(new Buku("03", "Psikologi"));
        dataBuku.add(new Buku ("04", "Pengantar Bisnis"));
